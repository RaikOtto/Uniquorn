...
If Uniquorn is available on bioconductor, you can simply type biocLite("Uniquorn") and continue to the next paragraph.
...
Registration for both websites is without charge and easy.
