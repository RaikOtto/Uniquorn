...
#' @param distinct_mode Should the mutational weights be calculated for all panels together or each for itelf? 
#' Recommendation: Seperately
#' @import DBI stringr R.utils RSQLite
#' @usage initiate_canonical_databases(
#' cosmic_file = "CosmicCLP_MutantExport.tsv", 
#' ccle_file = "CCLE_hybrid_capture1650_hg19_NoCommonSNPs_NoNeutralVariants_CDS_2012.05.07.maf")
#' @export
